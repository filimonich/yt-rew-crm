var _a, _b;
import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, ref, watchEffect, watch, h, shallowRef, shallowReactive, isReadonly, markRaw, toRaw, isRef, isReactive, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, defineComponent, provide, createElementBlock, isShallow, defineAsyncComponent, Suspense, mergeProps, Transition, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const mr = Symbol.toStringTag, bi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Ns = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Hs = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import("./_nuxt/multipart-parser-P7zV2KWh.js");
...
const unhead_KKeDGPM6sb = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/_id_-mjziCHNz.js").then((m) => m.default || m)
  },
  {
    name: "customers",
    path: "/customers",
    ...
    component: () => import("./_nuxt/index-MCePl0yF.js").then((m) => m.default || m)
  },
  {
    name: "feedback",
    path: "/feedback",
    ...
    component: () => import("./_nuxt/feedback-DeVVjejr.js").then((m) => m.default || m)
  },
  {
    name: "help",
    path: "/help",
    ...
    component: () => import("./_nuxt/help-DvFjhSVR.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index-YSnpLFiO.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    component: () => import("./_nuxt/login-BBdVzSJQ.js").then((m) => m.default || m)
  },
  {
    name: "orders",
    path: "/orders",
    ...
    component: () => import("./_nuxt/orders-hEclaEjI.js").then((m) => m.default || m)
  },
  {
    name: "payments",
    path: "/payments",
    ...
    component: () => import("./_nuxt/payments-C2x-tWbD.js").then((m) => m.default || m)
  },
  {
    name: "products",
    path: "/products",
    ...
    component: () => import("./_nuxt/products-C2bwsCcB.js").then((m) => m.default || m)
  },
  {
    name: "settings",
    path: "/settings",
    ...
    component: () => import("./_nuxt/settings-CL3jUumc.js").then((m) => m.default || m)
  },
  {
    name: "stat",
    path: "/stat",
    ...
    component: () => import("./_nuxt/stat-4ghwCyBO.js").then((m) => m.default || m)
  }
];
...
const revive_payload_server_HdGArudzLE = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/Icon-BsES4zWO.js").then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-CCIf3Eih.js").then((r) => r.default));
...
const modals_msHitmsIP2 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const _card = { "DEFAULT": "var(--card)", "foreground": "hsl(var(--card-foreground))" };
const _cool = { "50": "#f9fafb", "100": "#f3f4f6", "200": "#e5e7eb", "300": "#d1d5db", "400": "#9ca3af", "500": "#6b7280", "600": "#4b5563", "700": "#374151", "800": "#1f2937", "900": "#111827", "950": "#030712" };
const config = { "inherit": _inherit, "current": _current, "transparent": _transparent, "black": _black, "white": _white, "slate": _slate, "gray": _gray, "zinc": _zinc, "neutral": _neutral, "stone": _stone, "red": _red, "orange": _orange, "amber": _amber, "yellow": _yellow, "lime": _lime, "green": _green, "emerald": _emerald, "teal": _teal, "cyan": _cyan, "sky": _sky, "blue": _blue, "indigo": _indigo, "violet": _violet, "purple": _purple, "fuchsia": _fuchsia, "pink": _pink, "rose": _rose, "border": _border, "input": _input, "ring": _ring, "background": _background, "foreground": _foreground, "sidebar": _sidebar, "primary": _primary, "secondary": _secondary, "destructive": _destructive, "muted": _muted, "accent": _accent, "popover": _popover, "card": _card, "cool": _cool };
const colors_raMsOPoygA = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const vue_query_wrmMkNpEpe = /* @__PURE__ */ defineNuxtPlugin((nuxt) => {
...
const plugins = [
  ...
  plugin$1,
  plugin,
  revive_payload_server_HdGArudzLE,
...
const layouts = {
  default: () => import("./_nuxt/Default-Dw6hsazF.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-C8Bi2G0e.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-B6JJ_h8R.js").then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.10.3_vite@5.1.6/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-Ji9PJTro.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.10.3_vite@5.1.6/node_modules/nuxt/dist/app/components/nuxt-root.vue");
